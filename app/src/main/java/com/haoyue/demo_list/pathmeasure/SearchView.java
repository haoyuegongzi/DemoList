...
public class SearchView extends View {
    ...
    private int mViewWidth;// View 宽高
    ...
    public void initAll() {
        ...
        initHandler();
        initAnimator();
        mCurrentState = State.STARTING;// 进入开始动画
    ...
    private State mCurrentState = State.NONE;// 当前的状态(非常重要)
    private Path path_srarch;// 放大镜与外部圆环
    private Path path_circle;
    private PathMeasure mMeasure;// 测量Path 并截取部分的工具
    private int defaultDuration = 2000;// 默认的动效周期 2s
